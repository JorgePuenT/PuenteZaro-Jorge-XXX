...
@Transactional
public class PurletServiceTest extends AbstractTest {
	...
	protected void templateExamTestCase(String title, String secondTitle, String description, Date displayMoment, int gauge, String userBean, String newspaperBean, Class<?> expected, String explanation) {
		...
		try {
			...
			/////// Object creation ///////
			Purlet object = purletService.create();
			...
			/////// Validation ///////
			BindingResult binding = new BindException(object, "Purlet");
			Purlet reconstructed = purletService.reconstruct(object, binding);
			Assert.isTrue(!binding.hasErrors());

			/////// Save ///////
			Purlet saved = purletService.save(reconstructed);
			...
			/////// Second Validation ///////
			binding = new BindException(object, "Purlet");
			reconstructed = purletService.reconstruct(saved, binding);
			Assert.isTrue(!binding.hasErrors());

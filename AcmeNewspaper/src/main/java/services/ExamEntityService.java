...
public class ExamEntityService {
	...
	public ExamEntity save(ExamEntity examEntity) {
		if(examEntity.getId() == 0)
			Assert.isTrue(examEntity.getDisplayMoment() == null || examEntity.getDisplayMoment().after(new Date(System.currentTimeMillis()-1000)));
		else if(examEntity.getDisplayMoment() != null)
